...
$ ./familytreemaker.py -a 'Sample' sample.txt | dot -Tpng -o Sample.png

will generate the tree from the infos in Sample.txt, starting from
Sample and saving the image in Sample.png.

"""

__author__ = "Sadaananth Anbucheliyan"
__copyright__ = "Copyright 2023, Sadaananth Anbucheliyan"
__license__ = "GPL"
__version__ = "1.0"
